...
export const monthlyClosingV2ExpenseLines = mysqlTable("monthly_closing_v2_expense_lines", {
  ...
  payerType: mysqlEnum("payerType", ["none", "worker_paid", "company_card_etc", "company_paid", "client_paid_direct"]).default("none").notNull(),
  workerReimbursementRequired: boolean("workerReimbursementRequired").default(false).notNull(),
  clientBillable: boolean("clientBillable").default(false).notNull(),
  workerReimbursementAmount: int("workerReimbursementAmount").default(0).notNull(),
  clientBillableAmount: int("clientBillableAmount").default(0).notNull(),
