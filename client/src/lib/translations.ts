...
export const translations = {
  ...
  g3: {
    ja: {
      btnConsult: "工事のご相談",
      chipRecruit: "未経験歓迎・日当13,000円〜",
      chipLang: "日本語 / Português / English",
      bendNote: "BEND R — CONCENTRIC 90°",
      fin: "結線、完了。",
      skip: "スキップして相談する ↓",
      bbarConsult: "工事の相談",
      bbarApply: "応募する",
      ...
      faqTitle: "よくあるご質問",
      faq: [
        { q: "対応エリアはどこまでですか？", a: "東京・神奈川を中心に、埼玉・千葉まで対応しています。その他エリアも出張のご相談を承ります。" },
        { q: "どのような電気工事を依頼できますか？", a: "低圧設備工事・幹線工事・配管/ラック据付・配線工事・盤据付/結線など、一般電気用工作物工事全般に対応しています。" },
        { q: "未経験でも電気工事の仕事に応募できますか？", a: "応募できます。未経験者は日当13,000円〜スタートし、できる作業に応じて随時アップ。資格取得のサポート制度もあります。" },
        { q: "協力会社・元請けとしての取引は可能ですか？", a: "可能です。お問い合わせフォームまたはお電話（050-5873-4183）からご相談ください。" },
      ],
      recruitPoints: [
        "18歳以上・学歴/性別不問。未経験者を積極採用",
        "資格取得サポートあり（低圧電気取扱・高所作業車・職長安全衛生など）",
        "工具は最大6ヶ月貸出可",
        "経験者は要相談",
      ],
      wageLab: "DAILY WAGE — 未経験",
      wageUnit: "〜 / 日",
      wageNote: "できる作業により随時アップ。経験者は要相談。",
      prefs: ["東京都", "神奈川県", "埼玉県", "千葉県"],
      areaNote: "東京・神奈川中心／埼玉・千葉　※出張のご相談も承ります",
      contactTitle: "ご相談・ご応募はこちら",
      contactBody: "最後の一本まで、整えて締める。工事のご相談も、採用へのご応募も、下記からどうぞ。",
      qrLineworks: "ご相談はこちら",
    },
    pt: {
      btnConsult: "Consultar sobre obras",
      chipRecruit: "Iniciantes bem-vindos — diária a partir de ¥13.000",
      chipLang: "日本語 / Português / English",
      bendNote: "BEND R — CONCENTRIC 90°",
      fin: "Conexão concluída.",
      skip: "Pular e falar conosco ↓",
      bbarConsult: "Consultar",
      bbarApply: "Candidatar-se",
      bbarWage: "¥13.000〜/dia",
      faqTitle: "Perguntas Frequentes",
      faq: [
        { q: "Qual é a área de atuação?", a: "Atuamos principalmente em Tóquio e Kanagawa, atendendo também Saitama e Chiba. Para outras regiões, consulte-nos sobre deslocamento." },
        { q: "Que tipos de obras elétricas posso solicitar?", a: "Atendemos obras elétricas gerais, incluindo instalações de baixa tensão, alimentadores principais, eletrodutos e eletrocalhas, fiação e instalação e conexão de painéis." },
        { q: "Posso me candidatar sem experiência em obras elétricas?", a: "Sim. Iniciantes começam com diária a partir de ¥13.000, com aumentos conforme as habilidades adquiridas. Também oferecemos suporte para obtenção de qualificações." },
        { q: "É possível trabalhar conosco como empresa parceira ou contratante principal?", a: "Sim. Entre em contato pelo formulário ou por telefone (050-5873-4183)." },
      ],
      recruitPoints: [
        "Maiores de 18 anos, sem exigência de escolaridade ou gênero. Recrutamento ativo de iniciantes",
        "Suporte para obtenção de qualificações (baixa tensão, plataforma elevatória, líder de equipe e segurança etc.)",
        "Empréstimo de ferramentas por até 6 meses",
        "Profissionais experientes: condições a combinar",
      ],
      wageLab: "DIÁRIA — SEM EXPERIÊNCIA",
      wageUnit: "〜 / dia",
      wageNote: "Aumentos conforme as habilidades adquiridas. Experientes: a combinar.",
      prefs: ["Tóquio", "Kanagawa", "Saitama", "Chiba"],
      areaNote: "Foco em Tóquio e Kanagawa / Saitama e Chiba ※ Consulte-nos sobre deslocamento",
      contactTitle: "Fale conosco ou candidate-se",
      contactBody: "Até o último fio, organizado e apertado. Consultas sobre obras ou candidaturas — fale conosco abaixo.",
      qrLineworks: "Fale conosco",
    },
    en: {
      btnConsult: "Request a Consultation",
      chipRecruit: "Beginners welcome — from ¥13,000/day",
      chipLang: "日本語 / Português / English",
      bendNote: "BEND R — CONCENTRIC 90°",
      fin: "Termination complete.",
      ...
      faqTitle: "FAQ",
      faq: [
        { q: "What areas do you serve?", a: "We mainly serve Tokyo and Kanagawa, and also cover Saitama and Chiba. For other areas, please contact us about travel arrangements." },
        { q: "What kinds of electrical work can I request?", a: "We handle general electrical installation works, including low-voltage equipment, main line (feeder) work, conduit and cable tray installation, wiring, and panel installation and termination." },
        { q: "Can I apply without experience in electrical work?", a: "Yes. Beginners start at a daily rate of ¥13,000, with raises as your skills grow. We also offer support for obtaining qualifications." },
        { q: "Do you work with partner companies and general contractors?", a: "Yes. Please contact us via the inquiry form or by phone (050-5873-4183)." },
      ],
      recruitPoints: [
        "18+, no education or gender requirements. Beginners actively recruited",
        "Qualification support (low-voltage handling, aerial work platform, foreman & safety training, etc.)",
        "Tool lending for up to 6 months",
        "Experienced workers: negotiable",
      ],
      wageLab: "DAILY WAGE — NO EXPERIENCE",
      wageUnit: "+ / day",
      wageNote: "Raises as your skills grow. Experienced: negotiable.",
      prefs: ["Tokyo", "Kanagawa", "Saitama", "Chiba"],
      areaNote: "Mainly Tokyo & Kanagawa / Saitama & Chiba — travel available upon consultation",
      contactTitle: "Get in touch or apply",
      contactBody: "Down to the last wire, dressed and torqued. For project inquiries or job applications, reach out below.",
      qrLineworks: "Contact us",
    },
  },
  ...
  recruit: {
    ja: {
      ...
      intro: "充寵グループは、将来の法人化を見据え、創立メンバーとして共に歩んでくれる仲間を探しています。年齢・学歴・性別は問いません。未経験者も積極的に採用しています（年間未経験者4名まで、同時育成は最大約7名）。信頼と絆のある関係を築きたい方を歓迎します。",
      prioritiesTitle: "求める人物像",
      priorities: [
        "年齢18歳から・学歴・性別不問",
        "未経験者を積極採用",
        '将来の法人化を見据え、会社の\u201c柱\u201dになってほしい',
        "信頼と絆のある関係を築きたい方",
      ],
      ...
      insuranceItems: [
        ...
        "国民保険または建設業国民保険への加入を推奨します。（資格取得時のサポートや手当、法人化を見据え双方にメリットが多いため）",
      ],
      toolsTitle: "工具について",
      toolsBody: "腰道具などが揃えられない場合は６ヶ月間貸し出し可能です。まずは現場に慣れることを優先し、段階的に整えていく方針です。",
      payTitle: "日当",
      ...
      formBirthDay: "日",
      formEmail: "メールアドレス",
      formPrefecture: "住んでいる都道府県",
      formPrefectureSelect: "選択してください",
      formMotivation: "志望動機",
      formExperience: "経験",
      formExperienced: "経験者",
    ...
    pt: {
      ...
      formPrefectureSelect: "Selecione",
    ...
    en: {
      ...
      formBirthYear: "Year",
      formBirthMonth: "Month",
      formBirthDay: "Day",
      formEmail: "Email address",
      formPrefecture: "Prefecture / State of residence",
      formPrefectureSelect: "Please select",
