 ...
 */
export default function FirestopTool() {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <h2 className="text-base font-bold">耐火区画貫通 ガイド</h2>
      </div>

      {/* STEP1: 壁・床の種別 */}
      <div className="rounded-2xl border border-border bg-card/70 p-4">
        <div className="text-xs font-bold text-muted-foreground mb-2">STEP 1　壁・床の種別</div>
      ...
      {structure && (
        <div className="rounded-2xl border border-border bg-card/70 p-4">
          <div className="text-xs font-bold text-muted-foreground mb-2">STEP 2　貫通物</div>
          <div className="grid grid-cols-2 gap-2">
        ...
        <div className="space-y-3">
          ...
          <div className="rounded-2xl border border-border bg-card/70 p-4">
            <div className="text-xs text-muted-foreground">
              {getFirestopStructure(structure).name}｜{getFirestopPenetrant(penetrant).name}
            </div>
          ...
          >
            ...
            <p className="text-sm leading-relaxed">
              防火区画貫通は国土交通大臣認定工法の適用条件（壁厚・開口径・充填深さ等）に従うこと。
              実施工前に認定書・設計図書で必ず確認する。
            </p>
          </div>
          ...
          {/* 施工ポイントカード */}
          <div className="rounded-2xl border border-border bg-card/70 p-4">
            <div className="text-xs font-bold text-muted-foreground mb-2">施工ポイント</div>
      ...
      <div className="text-[11px] text-muted-foreground px-1 space-y-0.5">
        <p>※ 建築基準法施行令・一般周知の施工目安に基づく一般ガイドです。特定メーカーの認定内容を示すものではありません。</p>
        <p>※ 防火区画貫通は国土交通大臣認定工法の適用条件（壁厚・開口径・充填深さ）に従うこと。実施工前に認定書・設計図書で確認してください。</p>
        <p>※ 現場条件により異なる場合があります。現場実測・設計図書・施工要領書を優先してください。</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="rounded-2xl border border-border bg-card/70 p-4">
      <div className="flex items-center gap-2 mb-2">
        <div className="text-xs font-bold text-muted-foreground">チェックリスト</div>
        <span
