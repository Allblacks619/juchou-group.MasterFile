...
const STATUS_META: Record<string, { label: string; className: string }> = {
  pending: { label: "入金待ち", className: "bg-warning/15 text-warning border-warning/30" },
  partial: { label: "一部入金", className: "bg-info/15 text-info border-info/30" },
  received: { label: "入金済", className: "bg-success/15 text-success border-success/30" },
  overdue: { label: "期限超過", className: "bg-destructive/15 text-destructive border-destructive/30" },
